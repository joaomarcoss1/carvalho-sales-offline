...
const MEDEIROS_V5_PRODUCTS: Omit<Product, 'id' | 'createdAt'>[] = [
  // Pág 0002 - Perfumaria / Cosméticos
  { ref: '031696', name: 'OLEO DE MASSAGEM AVESTRUZ 120ML', price: 11.60, category: 'Perfumaria' },
  { ref: '031695', name: 'OLEO DE MASSAGEM CANELA DE VELHO 120ML', price: 11.60, category: 'Perfumaria' },
  { ref: '031697', name: 'OLEO DE MASSAGEM CASCAVEL 120ML', price: 11.60, category: 'Perfumaria' },
  { ref: '024966', name: 'OLEO REPARADOR DE PONTAS C/ARGAN 60ML', price: 15.90, category: 'Perfumaria' },
  { ref: '032091', name: 'OLEO REPARADOR DE PONTAS COCO 60ML', price: 15.90, category: 'Perfumaria' },
  { ref: '032092', name: 'OLEO REPARADOR DE PONTAS RISINO 60ML', price: 15.90, category: 'Perfumaria' },
  { ref: '032281', name: 'OLEO ROSA MOSQUETA 30ML', price: 12.00, category: 'Perfumaria' },
  { ref: '032379', name: 'PINCEL DE BARBIAR SQ REF 3783', price: 14.90, category: 'Perfumaria' },
  { ref: '031013', name: 'PROTETOR SOLAR 120ML', price: 18.90, category: 'Perfumaria' },
  { ref: '024833', name: 'REPARADOR DE PONTAS DE ARGAN', price: 8.50, category: 'Perfumaria' },
  { ref: '000013', name: 'REPARADOR DE PONTAS ESSENCTALY', price: 8.50, category: 'Perfumaria' },
  { ref: '000320', name: 'REPELENTE XO INSETO CREME 200ML', price: 23.90, category: 'Perfumaria' },
  { ref: '032157', name: 'REPELENTE XO INSETO SPREY', price: 23.90, category: 'Perfumaria' },
  { ref: '000014', name: 'ROLL-ON ESSENCIALY SORTIDO', price: 8.90, category: 'Perfumaria' },
  { ref: '032266', name: 'SABONETE ALBANY 90GR 12X1', price: 34.00, category: 'Perfumaria' },
  { ref: '032407', name: 'SABONETE EM BARRA ACAFRAO 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '032404', name: 'SABONETE EM BARRA AROEIRA 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '031015', name: 'SABONETE EM BARRA BARBATIMAO 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '032406', name: 'SABONETE EM BARRA BARBOSA 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '031017', name: 'SABONETE EM BARRA COCO 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '031016', name: 'SABONETE EM BARRA COPAIBA 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '023797', name: 'SABONETE EM BARRA ENXOFRE 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '032405', name: 'SABONETE EM BARRA ERVA DOCE 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '032386', name: 'SABONETE EM BARRA PIPINO 90GR', price: 3.96, category: 'Perfumaria' },
  { ref: '032385', name: 'SABONETE EM BARRA ROSA MOSQUETA 90GR', price: 3.96, category: 'Perfumaria' },
  // Pág 0003
  { ref: '032409', name: 'SABONETE EM BARRA TIRA MANCHAS 90GR', price: 6.50, category: 'Perfumaria' },
  { ref: '032408', name: 'SABONETE EM BARRA ZERO ESPINHA 90GR', price: 6.50, category: 'Perfumaria' },
  { ref: '030514', name: 'SABONETE INTIMO AROEIRA 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '032396', name: 'SABONETE INTIMO ARRUDA 200ML', price: 7.90, category: 'Perfumaria' },
  { ref: '029571', name: 'SABONETE INTIMO BARBATIMAO 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '032397', name: 'SABONETE INTIMO BEL MEM 200ML', price: 7.90, category: 'Perfumaria' },
  { ref: '032356', name: 'SABONETE INTIMO ICE BLECK 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '032357', name: 'SABONETE INTIMO MARACUJA 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '032410', name: 'SABONETE INTIMO MELANCIA 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '029596', name: 'SABONETE INTIMO MENTA 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '029421', name: 'SABONETE INTIMO MORANGO 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '005346', name: 'SABONETE INTIMO SORTIDO 200ML', price: 7.96, category: 'Perfumaria' },
  { ref: '024813', name: 'SABONETE INTIMOS 15 ERVAS 200ML', price: 7.39, category: 'Perfumaria' },
  { ref: '029846', name: 'SABONETE REXONA SORTIDO', price: 17.90, category: 'Perfumaria' },
  { ref: '026318', name: 'TALCO INFANTIL 100GR', price: 9.60, category: 'Perfumaria' },
  { ref: '023916', name: 'TALCO LEITE DE ROSA 100GR 12X1', price: 9.60, category: 'Perfumaria' },
  { ref: '030762', name: 'TINTURA BELA COR CASTANHO CLARO', price: 11.90, category: 'Perfumaria' },
  { ref: '030761', name: 'TINTURA BELA COR CASTANHO ESCURO', price: 11.90, category: 'Perfumaria' },
  { ref: '030763', name: 'TINTURA BELA COR CHOCOLATE', price: 11.90, category: 'Perfumaria' },
  { ref: '030764', name: 'TINTURA BELA COR LOURO CLARISSIMO', price: 11.90, category: 'Perfumaria' },
  { ref: '030760', name: 'TINTURA BELA COR PRETA', price: 11.90, category: 'Perfumaria' },
  { ref: '029726', name: 'TINTURA BELA COR VERMELHA', price: 11.90, category: 'Perfumaria' },
  { ref: '030343', name: 'ABAJU SQ PEQUENA', price: 28.90, category: 'Diversos' },
  // Pág 0004 - Diversos / Ferramentas
  { ref: '032307', name: 'ABRACADEIRA BORBOLETA 100X1 SQ REF.3937', price: 140.00, category: 'Ferramentas' },
  { ref: '032425', name: 'ABRACADEIRA DE NAYLON HM 530', price: 13.40, category: 'Ferramentas' },
  { ref: '032424', name: 'ABRACADEIRA DE NAYLON HM 531', price: 17.90, category: 'Ferramentas' },
  { ref: '032423', name: 'ABRACADEIRA DE NAYLON HM 532', price: 22.90, category: 'Ferramentas' },
  { ref: '032308', name: 'ABRACADEIRA ZINCADA 100X1 SQ REF.3936', price: 116.00, category: 'Ferramentas' },
  { ref: '000021', name: 'AGULHA DE MAQUINA N.11', price: 14.60, category: 'Diversos' },
  { ref: '031334', name: 'AGULHA DE MAQUINA N.14', price: 14.60, category: 'Diversos' },
  { ref: '031335', name: 'AGULHA DE MAQUINA N.16', price: 14.60, category: 'Diversos' },
  { ref: '031336', name: 'AGULHA DE MAQUINA N.18', price: 14.60, category: 'Diversos' },
  { ref: '000022', name: 'AGULHA DE SACO 50X1', price: 68.00, category: 'Diversos' },
  { ref: '000016', name: 'AGULHA FINA CORRENTE 20X1 N.06', price: 8.40, category: 'Diversos' },
  { ref: '031333', name: 'AGULHA FINA CORRENTE 20X1 N.07', price: 8.40, category: 'Diversos' },
  { ref: '000017', name: 'AGULHA GROSSA CORRENTE', price: 14.60, category: 'Diversos' },
  { ref: '000019', name: 'AGULHA P/CROCHE', price: 39.90, category: 'Diversos' },
  { ref: '000020', name: 'AGULHA P/FOGAO 50X1', price: 39.00, category: 'Pecas e Acessorio para Fogoes' },
  { ref: '026637', name: 'ALGODAO PACOTE 40X1', price: 96.00, category: 'Diversos' },
  { ref: '030274', name: 'ALICATE MONALIZA METAL', price: 18.90, category: 'Ferramentas' },
  { ref: '030771', name: 'ALICATE ORIGINAL CABO PLASTICO', price: 8.96, category: 'Ferramentas' },
  { ref: '029752', name: 'APARELHO DE BARBEAR MAX AZUL C/FITA LUBRIF 24X1', price: 31.60, category: 'Perfumaria' },
  { ref: '032415', name: 'APARELHO DE BARBIAR BIC 2 LAMINA', price: 1.96, category: 'Perfumaria' },
  { ref: '032111', name: 'APARELHO DE BARBIAR BIC 3 LAMINA', price: 3.60, category: 'Perfumaria' },
  { ref: '032471', name: 'APARELHO DE METAL SQ 1732', price: 5.90, category: 'Diversos' },
  { ref: '032234', name: 'BALADEIRA C/PLASTICO GROSSO 12X1', price: 88.00, category: 'Diversos' },
  { ref: '032372', name: 'BALANCA DE MESA CRS 2513', price: 32.00, category: 'Diversos' },
  { ref: '031656', name: 'BALANCA DE MOLA 100KL', price: 55.00, category: 'Diversos' },
  // Pág 0005
  { ref: '031654', name: 'BALANCA DE MOLA 25KL', price: 29.90, category: 'Diversos' },
  { ref: '031655', name: 'BALANCA DE MOLA 50KL', price: 39.90, category: 'Diversos' },
  { ref: '029242', name: 'BALANCA DIGITAL', price: 31.00, category: 'Diversos' },
  { ref: '032374', name: 'BALANCA DIGITAL QUADRADA', price: 39.00, category: 'Diversos' },
  { ref: '000026', name: 'BALAO SORTIDO', price: 8.40, category: 'Diversos' },
  { ref: '000029', name: 'BICO DE MAMADEIRA 100X1', price: 78.90, category: 'Diversos' },
  { ref: '000030', name: 'BICO DE MAMADEIRA PEROLA SILICONE 25X1', price: 63.00, category: 'Diversos' },
  { ref: '023792', name: 'BOLA BICO DE JACA 120GR', price: 11.90, category: 'Diversos' },
  { ref: '023793', name: 'BOLA BICO DE JACA 180GR', price: 12.90, category: 'Diversos' },
  { ref: '023794', name: 'BOLA BICO DE JACA 300GR', price: 18.60, category: 'Diversos' },
  { ref: '023795', name: 'BOLA BICO DE JACA 500GR', price: 31.90, category: 'Diversos' },
  { ref: '023791', name: 'BOLA BICO DE JACA 80GR', price: 8.40, category: 'Diversos' },
  { ref: '023796', name: 'BOLA BICO DE JACA MINI 12X1', price: 39.90, category: 'Diversos' },
  { ref: '032431', name: 'BOMBA DE AR PARA BICICLETA GRANDE', price: 29.90, category: 'Diversos' },
  { ref: '032430', name: 'BOMBA DE AR PARA BICICLETA PEQUENA', price: 19.90, category: 'Diversos' },
  { ref: '000250', name: 'BOMBA DE AR PARA BICICLETA YAMARA GRANDE', price: 46.00, category: 'Diversos' },
  { ref: '000025', name: 'BOMBA DE AR PARA BICICLETA YAMARA PEQUENO', price: 36.00, category: 'Diversos' },
  { ref: '028434', name: 'BONE ABA RETA SORTIDO', price: 24.00, category: 'Diversos' },
  { ref: '031693', name: 'BONE DE LONA', price: 26.00, category: 'Diversos' },
  { ref: '030337', name: 'BONE DE PESCADOR CAMUFLADO', price: 18.00, category: 'Diversos' },
  { ref: '030811', name: 'BONE DE TELA CARA DE CAVALO', price: 24.00, category: 'Diversos' },
  { ref: '028614', name: 'BONE DE TELA SORTIDO', price: 24.00, category: 'Diversos' },
  { ref: '030335', name: 'BONE DE VAQUEJADA DE TELA', price: 24.00, category: 'Diversos' },
  { ref: '028615', name: 'BONE FECHADO SORTIDO', price: 18.00, category: 'Diversos' },
  { ref: '028433', name: 'BONE JHON JHON ABA RETA', price: 24.00, category: 'Diversos' },
  // Pág 0006
  { ref: '028432', name: 'BONE JHON JHON SORTIDO', price: 24.00, category: 'Diversos' },
  { ref: '030336', name: 'BONE NELORE DE TELA', price: 24.00, category: 'Diversos' },
  { ref: '031014', name: 'BONE PESCADOR COLORIDO', price: 20.00, category: 'Diversos' },
  { ref: '030137', name: 'BONE REFORCADO DE BROXE', price: 20.00, category: 'Diversos' },
  { ref: '017820', name: 'BONETA REFORCADA DA ADIDAS', price: 20.00, category: 'Diversos' },
  { ref: '017818', name: 'BONETA REFORCADA DA NAKY', price: 20.00, category: 'Diversos' },
  { ref: '017819', name: 'BONETA REFORCADA DA PUMA', price: 20.00, category: 'Diversos' },
  { ref: '017943', name: 'BONETA REFORCADA DE MARCAS', price: 20.00, category: 'Diversos' },
  { ref: '017942', name: 'BONETA REFORCADA DE TIMES', price: 20.00, category: 'Diversos' },
  { ref: '017814', name: 'BONETA REFORCADA DO CORINTHIAS', price: 20.00, category: 'Diversos' },
  { ref: '017812', name: 'BONETA REFORCADA DO FLAMENGO', price: 20.00, category: 'Diversos' },
  { ref: '017817', name: 'BONETA REFORCADA DO PALMEIRAS', price: 20.00, category: 'Diversos' },
  { ref: '017816', name: 'BONETA REFORCADA DO SANTOS', price: 20.00, category: 'Diversos' },
  { ref: '017813', name: 'BONETA REFORCADA DO SAO PAULO', price: 20.00, category: 'Diversos' },
  { ref: '017815', name: 'BONETA REFORCADA DO VASCO', price: 20.00, category: 'Diversos' },
  { ref: '017823', name: 'BONETA REFORCADA NELORY', price: 20.00, category: 'Diversos' },
  { ref: '017822', name: 'BONETA REFORCADA VAQUEJADA', price: 20.00, category: 'Diversos' },
  { ref: '032289', name: 'CABO PARA RODO', price: 4.46, category: 'Diversos' },
  { ref: '017824', name: 'CABRESTO DE SANDALIA COMUM MASCULINA', price: 1.80, category: 'Diversos' },
  { ref: '030768', name: 'CABRESTO DE SANDALIA COMUN FEMININA', price: 1.80, category: 'Diversos' },
  { ref: '010012', name: 'CABRESTO DE SANDALIA SILICONE FEMININA', price: 1.95, category: 'Diversos' },
  { ref: '026343', name: 'CABRESTO DE SANDALIA SILICONE MASCULINO', price: 1.95, category: 'Diversos' },
  { ref: '032286', name: 'CAPA DE CHUVA ADULTO', price: 20.00, category: 'Diversos' },
  { ref: '032285', name: 'CAPA DE CHUVA INFANTIL', price: 12.00, category: 'Diversos' },
  // Pág 0007
  { ref: '023803', name: 'CARTAO DE MEMORIA 8GB', price: 32.00, category: 'Eletronicos' },
  { ref: '030477', name: 'CHAPEU BOIADEIRO 2 CAPA', price: 24.00, category: 'Diversos' },
  { ref: '032329', name: 'CHAPEU CAMINHONEIRO C/FRASE', price: 54.00, category: 'Diversos' },
  { ref: '030415', name: 'CHAPEU CAMUCA', price: 32.00, category: 'Diversos' },
  { ref: '031795', name: 'CHAPEU CHINES ORIENTAL', price: 40.00, category: 'Diversos' },
  { ref: '032195', name: 'CHAPEU COURO CABANO GRANDE', price: 80.00, category: 'Diversos' },
  { ref: '032196', name: 'CHAPEU COURO CABANO PEQUENO', price: 50.00, category: 'Diversos' },
  { ref: '032197', name: 'CHAPEU COURO GAUCHO GRANDE', price: 80.00, category: 'Diversos' },
  { ref: '032198', name: 'CHAPEU COURO GAUCHO PEQUENO', price: 50.00, category: 'Diversos' },
  { ref: '032199', name: 'CHAPEU COURO LAMPIAO GRANDE', price: 100.00, category: 'Diversos' },
  { ref: '032200', name: 'CHAPEU COURO LAMPIAO MEDIO', price: 90.00, category: 'Diversos' },
  { ref: '032201', name: 'CHAPEU COURO LAMPIAO PEQUENO', price: 70.00, category: 'Diversos' },
  { ref: '031698', name: 'CHAPEU DE CAMINHONEIRO', price: 50.00, category: 'Diversos' },
  { ref: '028610', name: 'CHAPEU DE COURO SINTETICO', price: 68.00, category: 'Diversos' },
  { ref: '031692', name: 'CHAPEU DE ESTOPA', price: 36.00, category: 'Diversos' },
  { ref: '028606', name: 'CHAPEU DE LONA', price: 36.00, category: 'Diversos' },
  { ref: '028607', name: 'CHAPEU DE MALADRINHO', price: 22.00, category: 'Diversos' },
  { ref: '028605', name: 'CHAPEU DE MASSA', price: 36.00, category: 'Diversos' },
  { ref: '032331', name: 'CHAPEU DE PALHA C/FRASE', price: 34.00, category: 'Diversos' },
  { ref: '030675', name: 'CHAPEU DE PALHA CAWBOY', price: 19.00, category: 'Diversos' },
  { ref: '032330', name: 'CHAPEU DE PALHA DE TIME', price: 34.00, category: 'Diversos' },
  { ref: '030357', name: 'CHAPEU DE PALHA MEDIO', price: 12.00, category: 'Diversos' },
  { ref: '030358', name: 'CHAPEU DE PALHA MEDIO 2 CAPA', price: 20.00, category: 'Diversos' },
  { ref: '030360', name: 'CHAPEU DE PALHA MEXICANO', price: 20.00, category: 'Diversos' },
  { ref: '030361', name: 'CHAPEU DE PALHA MEXICANO 2 CAPA', price: 29.00, category: 'Diversos' },
  // Pág 0008
  { ref: '032089', name: 'CHAPEU DE PALHA NELORE', price: 20.00, category: 'Diversos' },
  { ref: '032090', name: 'CHAPEU DE PALHA NELORE COM BORDA', price: 20.00, category: 'Diversos' },
  { ref: '030356', name: 'CHAPEU DE PALHA PEQUENO', price: 7.00, category: 'Diversos' },
  { ref: '030676', name: 'CHAPEU DE PALHA SUPER LUXO', price: 18.00, category: 'Diversos' },
  { ref: '031791', name: 'CHAPEU DE PANO CAMUFLADO', price: 20.00, category: 'Diversos' },
  { ref: '028602', name: 'CHAPEU DE PANO COLORIDO', price: 20.00, category: 'Diversos' },
  { ref: '028608', name: 'CHAPEU DE PESCADOR CAMUFLADO', price: 22.00, category: 'Diversos' },
  { ref: '028603', name: 'CHAPEU DE TELA', price: 36.00, category: 'Diversos' },
  { ref: '031700', name: 'CHAPEU LONITA CAMUFLADO', price: 36.00, category: 'Diversos' },
  { ref: '032256', name: 'CHAPEU MEDIO C/FITA', price: 10.00, category: 'Diversos' },
  { ref: '030810', name: 'CHAPEU PALHA PEQUENO FEMININA', price: 8.00, category: 'Diversos' },
  { ref: '030809', name: 'CHAPEU PALHA PEQUENO MASCULINO', price: 8.00, category: 'Diversos' },
  { ref: '028600', name: 'CHAPEU PALINHA', price: 26.00, category: 'Diversos' },
  { ref: '032255', name: 'CHAPEU PEQUENO C/FITA', price: 10.00, category: 'Diversos' },
  { ref: '031011', name: 'CHAPEU PESCADOR COLORIDO', price: 22.00, category: 'Diversos' },
  { ref: '032254', name: 'CHAPEU QUADRILHA FEMININA', price: 14.00, category: 'Diversos' },
  { ref: '032251', name: 'CHAPEU QUADRILHA GRANDE', price: 10.00, category: 'Diversos' },
  { ref: '032252', name: 'CHAPEU QUADRILHA MEDIO', price: 10.00, category: 'Diversos' },
  { ref: '032253', name: 'CHAPEU QUADRILHA PEQUENO', price: 10.00, category: 'Diversos' },
  { ref: '028601', name: 'CHAPEU SOFA', price: 36.00, category: 'Diversos' },
  { ref: '032377', name: 'CHAVEIRO DE METAL REF.9152', price: 5.96, category: 'Diversos' },
  { ref: '032378', name: 'CHAVEIRO DE METAL REF.9162', price: 5.96, category: 'Diversos' },
  { ref: '000039', name: 'CHUPETA BORBOLETA DECORADA 25X1', price: 59.00, category: 'Diversos' },
  { ref: '000040', name: 'CHUPETA BORBOLETA LISA 25X1', price: 46.80, category: 'Diversos' },
  { ref: '000041', name: 'CHUPETA SILICONE 25X1', price: 69.00, category: 'Diversos' },
  // Pág 0009
  { ref: '000042', name: 'CHUPETA TRADICIONAL 50X1', price: 79.00, category: 'Diversos' },
  { ref: '023728', name: 'CINTO MASCULINA PARA CALCA C/FIVELA', price: 24.00, category: 'Diversos' },
  { ref: '032280', name: 'COLA CIBRA BONDE 20GR', price: 6.90, category: 'Diversos' },
  { ref: '032076', name: 'COLA RATO SQ', price: 3.90, category: 'Diversos' },
  { ref: '000043', name: 'COLA TUDO 12X1', price: 24.90, category: 'Diversos' },
  { ref: '024070', name: 'CORDA DE VARAL DE ACO 15MT', price: 3.79, category: 'Diversos' },
  { ref: '024071', name: 'CORDA DE VARAL DE ACO 20MT', price: 4.79, category: 'Diversos' },
  { ref: '000044', name: 'CORDA P/VARAL DE ACO 10MST', price: 2.89, category: 'Diversos' },
  { ref: '032295', name: 'DOMINO OSSO EM MALETA SQ REF.3442', price: 59.00, category: 'Diversos' },
  { ref: '032294', name: 'DOMINO OSSO SQ REF.3440', price: 31.90, category: 'Diversos' },
  { ref: '032293', name: 'DOMINO OSSO SQ REF.3443', price: 54.00, category: 'Diversos' },
  { ref: '000051', name: 'ELASTICO N.06', price: 37.90, category: 'Diversos' },
  { ref: '000052', name: 'ELASTICO N.08', price: 41.80, category: 'Diversos' },
  { ref: '000053', name: 'ELASTICO N.10', price: 43.50, category: 'Diversos' },
  { ref: '000054', name: 'ELASTICO N.12', price: 48.90, category: 'Diversos' },
  { ref: '000055', name: 'ELASTICO N.14', price: 59.90, category: 'Diversos' },
  { ref: '000056', name: 'ELASTICO N.16', price: 68.90, category: 'Diversos' },
  { ref: '031204', name: 'ELASTICO N.18', price: 76.80, category: 'Diversos' },
  { ref: '032482', name: 'ELASTICO PARA CABELO HM 171', price: 26.00, category: 'Perfumaria' },
  { ref: '032483', name: 'ELASTICO PARA CABELO HM 190', price: 26.00, category: 'Perfumaria' },
  { ref: '032484', name: 'ELASTICO PARA CABELO HM 191', price: 26.00, category: 'Perfumaria' },
  { ref: '032485', name: 'ELASTICO PARA CABELO HM 422', price: 26.00, category: 'Perfumaria' },
  { ref: '000060', name: 'ESCOVA DE LAVAR ROUPA DE MADEIRA', price: 40.80, category: 'Limpeza' },
  { ref: '000061', name: 'ESCOVA DE LAVAR ROUPA DE PLASTICO', price: 44.80, category: 'Limpeza' },
  { ref: '004292', name: 'ESCOVA DENTAL ADULTA C/LIMP.E PROTETOR', price: 26.00, category: 'Perfumaria' },
  // Pág 0010
  { ref: '011350', name: 'ESCOVA DENTAL INFANTIL C/LIMP.E PROTETOR', price: 26.00, category: 'Perfumaria' },
  { ref: '032394', name: 'ESCOVA DENTAL INFANTIL MZ 603', price: 11.90, category: 'Perfumaria' },
  { ref: '032382', name: 'ESCOVA DENTAL INFANTIL MZ 83', price: 11.90, category: 'Perfumaria' },
  { ref: '032383', name: 'ESCOVA DENTAL INFANTIL MZ 86', price: 11.90, category: 'Perfumaria' },
  { ref: '032381', name: 'ESCOVA PARA CABELO MZ 609', price: 16.90, category: 'Perfumaria' },
  { ref: '032363', name: 'ESCOVA PARA CABELO REF.M607', price: 16.90, category: 'Perfumaria' },
  { ref: '032362', name: 'ESCOVA PARA CABELO REF.M610', price: 16.90, category: 'Perfumaria' },
  { ref: '032359', name: 'ESCOVA PARA CABELO REF.MZ606', price: 16.90, category: 'Perfumaria' },
  { ref: '032360', name: 'ESCOVA PARA CABELO REF.MZ84', price: 16.90, category: 'Perfumaria' },
  { ref: '026288', name: 'ESCOVA PARA UNHA 12X1', price: 34.90, category: 'Perfumaria' },
  { ref: '032288', name: 'ESCOVA PARA UNHA 2X1 REF.3967', price: 4.69, category: 'Perfumaria' },
  { ref: '021889', name: 'ESMALTE DELIRIO SORTIDO', price: 38.00, category: 'Perfumaria' },
  { ref: '000062', name: 'ESPELHO N.10', price: 68.90, category: 'Diversos' },
  { ref: '000063', name: 'ESPELHO N.12', price: 71.90, category: 'Diversos' },
  { ref: '000064', name: 'ESPELHO N.14', price: 82.90, category: 'Diversos' },
  { ref: '000065', name: 'ESPELHO N.16', price: 97.60, category: 'Diversos' },
  { ref: '030902', name: 'ESPELHO N.18', price: 122.00, category: 'Diversos' },
  { ref: '031205', name: 'ESPELHO N.20', price: 146.00, category: 'Diversos' },
  { ref: '000066', name: 'ESPELHO OVAL P/BOLCO 36X1', price: 69.80, category: 'Diversos' },
  { ref: '023569', name: 'ESPONJA DUPLA FACE 60X1', price: 49.90, category: 'Limpeza' },
  { ref: '026681', name: 'EXTENCAO REDONDA 5 METROS', price: 15.90, category: 'Mat. Eletrico/Hidraulico' },
  { ref: '003041', name: 'FACA SQ CABO DE BORRACHA 8 POLEGADA', price: 15.30, category: 'Cutelaria' },
  { ref: '021803', name: 'FITA LARGA PARA CAIXA 5X1', price: 23.90, category: 'Diversos' },
  { ref: '032274', name: 'FITA METRICA 10 METROS', price: 22.90, category: 'Ferramentas' },
